...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http.authorizeHttpRequests(auths -> auths
                ...
                .requestMatchers(HttpMethod.GET, api + "/products/**").hasAnyRole("OWNER", "USER", "ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, api + "/customers/**").hasAnyRole("OWNER", "USER", "ADMIN")
                .requestMatchers(HttpMethod.POST, api + "/customers/**").hasAnyRole("OWNER", "ADMIN")
                .requestMatchers(HttpMethod.PUT, api + "/customers/**").hasAnyRole("OWNER", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, api + "/customers/**").hasAnyRole("OWNER", "ADMIN")
                .requestMatchers(api + "/invoices/**").hasAnyRole("OWNER", "USER", "ADMIN")
                .requestMatchers(api + "/ai/**").hasAnyRole("OWNER", "USER", "ADMIN")
