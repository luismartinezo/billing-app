...
const TRANSLATIONS: TranslationDictionary = {
  ...
  'invoice.paymentExceedsBalance': { es: 'El pago no puede superar el saldo pendiente.', en: 'The payment cannot exceed the outstanding balance.' },
  'invoice.paymentNotAllowed': { es: 'Esta factura no admite pagos en su estado actual.', en: 'This invoice does not accept payments in its current status.' },
  'invoice.paymentComplete': { es: 'La factura está completamente pagada.', en: 'The invoice is fully paid.' },
  'invoice.paymentUnavailable': { es: 'Los pagos estarán disponibles cuando la factura esté emitida.', en: 'Payments will be available after the invoice is issued.' },
  'invoice.issue': { es: 'Emitir', en: 'Issue' },
  'invoice.cancel': { es: 'Cancelar factura', en: 'Cancel invoice' },
  'invoice.issuedSuccess': { es: 'Factura emitida correctamente.', en: 'Invoice issued successfully.' },
  'invoice.cancelledSuccess': { es: 'Factura cancelada correctamente.', en: 'Invoice cancelled successfully.' },
  'invoice.issueError': { es: 'No se pudo emitir la factura.', en: 'The invoice could not be issued.' },
  'invoice.cancelError': { es: 'No se pudo cancelar la factura.', en: 'The invoice could not be cancelled.' },
  'invoice.deleteError': { es: 'No se pudo eliminar la factura.', en: 'The invoice could not be deleted.' },
  'invoice.confirmCancelTitle': { es: 'Cancelar factura', en: 'Cancel invoice' },
  'invoice.confirmCancelMessage': { es: 'La factura quedará cancelada y no podrá recibir pagos. ¿Deseas continuar?', en: 'The invoice will be cancelled and will no longer accept payments. Do you want to continue?' },
  'invoice.confirmDeleteTitle': { es: 'Eliminar factura', en: 'Delete invoice' },
  'invoice.confirmDeleteMessage': { es: 'Esta acción eliminará la factura definitivamente. ¿Deseas continuar?', en: 'This action will permanently delete the invoice. Do you want to continue?' },
  'invoice.confirmAction': { es: 'Confirmar', en: 'Confirm' },
  'invoice.processing': { es: 'Procesando...', en: 'Processing...' },
  ...
  'status.OVERDUE': { es: 'VENCIDA', en: 'OVERDUE' },
